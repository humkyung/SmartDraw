...
DWORD CPPHtmlDrawer::GetTagFromList(CString sTagName, CString & strFullName, BOOL & bCloseTag)
{
	strFullName.Empty();
...
SIZE CPPHtmlDrawer::DrawHtmlTable (CString & sTable, LPCRECT lpRect)
{
	...
	CString sProperties = SplitTag(sTag);
	...
	if (szTable.cx && szTable.cy)
	{
		int nNewRow = 0;
		int nEndRow;
		CString sTagName, sTagParam, sRow;
		for (i = 0; i < szTable.cy; ++i)
		{
...
//
///////////////////////////////////////////////////////////////////////////////
void CPPHtmlDrawer::DrawHtmlTableRow(CString & sRow, LPCRECT lpRect, STRUCT_TABLE & st, int nRow)
{
	...
	while (nIndex < sRow.GetLength())
	{
		...
		if (nNewCell < nEndRow)
		{
			...
			CString sCell = sRow.Mid(nNewCell, nIndex - nNewCell);
...
//
///////////////////////////////////////////////////////////////////////////////
void CPPHtmlDrawer::DrawHtmlTableCell(CString & sCell, LPCRECT lpRect, STRUCT_CELL & sc)
{
	if (MODE_DRAW != m_nNumPass)
	{
		sc.szText.cx = 0;
	...
	while(nIndex < sCell.GetLength())
	{
		...
		if (nNearlyTag > nIndex)
		{
			...
			CString sText = sCell.Mid(nIndex, nNearlyTag - nIndex);
		...
		else if (nNewTable < nEndCell)
		{
			...
			CString sTable = sCell.Mid(nNewTable, nIndex - nNewTable);
...
SIZE CPPHtmlDrawer::DrawHtmlString (CString & sHtml, LPCRECT lpRect)
{
	SIZE szTextArea = {0, 0};
	...
	CString sText = _T("");
	CString sTag = _T(""); //String of the tag
	CString sProperties = _T(""); //String of the tag's property
...
/////////////////////////////////////////////////////////////////
CString CPPHtmlDrawer::SearchNextTag(CString & str, CString & strTag, int & nIndex)
{
	int nBegin;
	CString sText = _T("");
	strTag.Empty();
...
//	A tag's name .
/////////////////////////////////////////////////////////////////
CString CPPHtmlDrawer::GetTagBody(CString & str, int & nIndex)
{
	CString sTagName = _T("");
...
/////////////////////////////////////////////////////////////////
CString CPPHtmlDrawer::SplitTag(CString & sTag)
{
	CString sParam(_T(""));
	int nIndex = 0;
...
CString CPPHtmlDrawer::GetNextProperty(CString & str, int & nIndex, CString & sProp)
{
	CString sValue(_T(""));
	sProp.Empty();
...
/////////////////////////////////////////////////////
SIZE CPPHtmlDrawer::GetTableDimensions(CString & sTable)
{
...
/////////////////////////////////////////////////////
void CPPHtmlDrawer::SearchEndOfRow(CString & str, int & nIndex)
{
	nIndex += 4;
...
/////////////////////////////////////////////////////
void CPPHtmlDrawer::SearchEndOfCell(CString & str, int & nIndex)
{
	nIndex += 4;
...
///////////////////////////////////////////////////////////////////////
SIZE CPPHtmlDrawer::AnalyseCellParam(CString & sProperties, _STRUCT_CHANGESTYLE & cs, BOOL bTable)
{
	SIZE szSpan = {1, 1};
	if (sProperties.IsEmpty())
		return szSpan;
...
///////////////////////////////////////////////////////////////////////
void CPPHtmlDrawer::AnalyseImageParam(CString & sProperties, _STRUCT_IMAGE & si)
{
	if (sProperties.IsEmpty())
		return;
...
void CPPHtmlDrawer::DrawBackgroundImage(HDC hDC, int nDestX, int nDestY, int nWidth, int nHeight, CString strNameImage)
{
	if (!m_bIsEnable)
		return;
...
CString CPPHtmlDrawer::GetWordWrap(CString & str, int nMaxSize, int & nRealSize)
{
	int nCurIndex = 0;
	int nLastIndex = 0;
	SIZE sz = {0, 0};
...
int CPPHtmlDrawer::GetCountOfChars(CString str, TCHAR tchar /*= _T(' ')*/)
{
	int nCount = 0;
	//ENG:
	//RUS:
