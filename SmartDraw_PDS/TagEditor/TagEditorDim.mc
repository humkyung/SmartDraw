/*----------------------------------------------------------------------+
|                                                                       |
|   TagEditor.mc - Dimension and Manipulation source code               |
|                                                                       |
+----------------------------------------------------------------------*/
/*----------------------------------------------------------------------+
|                                                                       |
...
cmdNumber       CMD_TECHSUN_DIMJUSTIFYLEFT	
{  	
    mdlLocate_allowLocked () ;
    mdlLocate_init () ;
...
cmdNumber       CMD_TECHSUN_DIMJUSTIFYRIGHT
{  	
    mdlLocate_allowLocked () ;
    mdlLocate_init () ;
...
cmdNumber       CMD_TECHSUN_DIMJUSTIFYCENTER
{  	
    mdlLocate_allowLocked () ;
    mdlLocate_init () ;
...
cmdNumber       CMD_TECHSUN_DIMTEXTMOVEABOVE
{  	
    mdlLocate_allowLocked () ;
    mdlLocate_init () ;
...
cmdNumber       CMD_TECHSUN_DIMTEXTMOVEINLINE
{  	
...
cmdNumber       CMD_TECHSUN_DIMTEXTMOVEBELOW
{  	
    mdlLocate_allowLocked () ;
    mdlLocate_init () ;
...
cmdNumber       CMD_TECHSUN_DIMCHANGELEFTBOTTOMTERMIANTORTODOT
{  	
    mdlLocate_allowLocked () ;
    mdlLocate_init () ;
...
cmdNumber       CMD_TECHSUN_DIMCHANGECENTERTERMIANTORSTODOT
{  	
...
cmdNumber       CMD_TECHSUN_DIMCHANGERIGHTTOPTERMIANTORTODOT
{  	
    mdlLocate_allowLocked () ;
    mdlLocate_init () ;
...
cmdNumber       CMD_TECHSUN_DIMCHANGETOPTERMIANTORSTODOT
{  	
    mdlLocate_allowLocked () ;
    mdlLocate_init () ;
...
cmdNumber       CMD_TECHSUN_DIMCHANGEBOTTOMTERMIANTORSTODOT
{  	
    mdlLocate_allowLocked () ;
    mdlLocate_init () ;
