// InPlaceFilterEdit.cpp : implementation file
//
...
CInPlaceFilterEdit::CInPlaceFilterEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           ...
                           UINT nFirstChar)
{
	...
	SetRegEx(_T("[-+]?([0-9]*)?(\\.)?[0-9]*"));
	SetBackgroundColourFocus (RGB (150, 200, 255));
	SetForegroundColourError (RGB (255, 255, 255));
	SetBackgroundColourError (RGB (255, 0, 0));
	CreateToolTip(pParent, _T(": is invalid value."));
...
CInPlaceFilterEdit::~CInPlaceFilterEdit()
{
}


BEGIN_MESSAGE_MAP(CInPlaceFilterEdit, CFilterEdit)
	//{{AFX_MSG_MAP(CInPlaceFilterEdit)
	ON_WM_KILLFOCUS()
	ON_WM_CHAR()
	ON_WM_KEYDOWN()
	ON_WM_GETDLGCODE()
...
/////////////////////////////////////////////////////////////////////////////
// CInPlaceFilterEdit message handlers
// If an arrow key (or associated) is pressed, then exit if
//  a) The Ctrl key was down, or
//  b) m_bExitOnArrows == TRUE
void CInPlaceFilterEdit::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
void CInPlaceFilterEdit::OnKillFocus(CWnd* pNewWnd)
{
	CFilterEdit::OnKillFocus(pNewWnd);
	EndEdit();
}

void CInPlaceFilterEdit::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
...
UINT CInPlaceFilterEdit::OnGetDlgCode() 
{
...
BOOL CInPlaceFilterEdit::PreTranslateMessage(MSG* pMsg) 
{
...
// Auto delete
void CInPlaceFilterEdit::PostNcDestroy() 
{
	CFilterEdit::PostNcDestroy();
...
void CInPlaceFilterEdit::EndEdit()
{
	CString str;
