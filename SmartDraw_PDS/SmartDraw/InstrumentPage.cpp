// InstrumentPage.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CInstrumentPage, CSmartDrawPropertyPage)

CInstrumentPage::CInstrumentPage(CWnd* pParent /*=NULL*/)
	: CSmartDrawPropertyPage(CInstrumentPage::IDD, pParent)
{

}

CInstrumentPage::~CInstrumentPage()
{
}

void CInstrumentPage::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CInstrumentPage, CSmartDrawPropertyPage)
	ON_CBN_SELENDOK(IDC_COMBO_ENCLOSURE_TYPE, &CInstrumentPage::OnCbnSelendokComboEnclosureType)
	///ON_CBN_SELENDOK(IDC_COMBO_LABEL_TYPE, &CInstrumentPage::OnCbnSelendokComboLabelType)
END_MESSAGE_MAP()


// CInstrumentPage message handlers

BOOL PropertyPage::CInstrumentPage::OnInitDialog()
{
...
void PropertyPage::CInstrumentPage::OnCbnSelendokComboEnclosureType()
{
...
//void PropertyPage::CInstrumentPage::OnCbnSelendokComboLabelType()
//{
//	CComboBox* pComboBox = (CComboBox*)GetDlgItem(IDC_COMBO_LABEL_TYPE);
//	const int nSel = pComboBox->GetCurSel();
//	switch(nSel)
//	{
//		case 0:
//			m_wndLabelType.Load(GetExecPath() + _T("\\Resource\\instrument_label_type_00.bmp"));
//			break;
//		case 1:
//			m_wndLabelType.Load(GetExecPath() + _T("\\Resource\\instrument_label_type_01.bmp"));
//			break;
//		case 2:
//			m_wndLabelType.Load(GetExecPath() + _T("\\Resource\\instrument_label_type_02.bmp"));
//			break;
//	}
//	m_wndLabelType.Draw();
//}
...
/**
	...
	@date	?
*/
int PropertyPage::CInstrumentPage::LoadData(void)
{
	const CString rApp(_T("Instrument"));
...
/**
	...
	@date	2010.06.25
*/
int PropertyPage::CInstrumentPage::SaveData(void)
{
	const CString rApp(_T("Instrument"));
	UpdateData();
