...
CCableTrayPage* CCableTrayPage::instance = NULL;
/******************************************************************************
    @author     humkyung
    @date       2012-02-20
...
BOOL CCableTrayPage::OnInitDialog()
{
	...
	m_wndTextColorButton.FillColors(m_sIniFilePath);
	m_wndElecHatchColorButton.FillColors(m_sIniFilePath);
	m_wndInstHatchColorButton.FillColors(m_sIniFilePath);
...
/******************************************************************************
    ...
    @brief
******************************************************************************/
int CCableTrayPage::LoadData(void)
{
...
/******************************************************************************
    ...
    @brief
******************************************************************************/
int CCableTrayPage::SaveData(void)
{
	static const STRING_T sApp(_T("ANNOTATION_OPTIONS"));
...
/******************************************************************************
    ...
    @brief
******************************************************************************/
void CCableTrayPage::NotifyDisplayTooltip(NMHDR * pNMHDR, LRESULT * result)
{
	TCHAR szBuf[MAX_PATH + 1]={'\0',};
...
/******************************************************************************
    ...
    @brief
******************************************************************************/
BOOL CCableTrayPage::PreTranslateMessage(MSG* pMsg)
{
...
/******************************************************************************
    ...
    @brief
******************************************************************************/
void CCableTrayPage::OnEnChangeEditCellLibraryFilePath()
{
...
void CCableTrayPage::OnBnClickedCheckElec()
{
...
/******************************************************************************
    ...
    @brief
******************************************************************************/
void CCableTrayPage::OnBnClickedCheckElecOutline()
{
...
/******************************************************************************
    ...
    @brief
******************************************************************************/
void CCableTrayPage::OnBnClickedCheckInst()
{
...
/******************************************************************************
    ...
    @brief
******************************************************************************/
void CCableTrayPage::OnBnClickedCheckInstOutline()
{
