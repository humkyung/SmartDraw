...
int _tmain(int argc, TCHAR* argv[], TCHAR* envp[])
{
	...
	{
		HMODULE hModule = AfxLoadLibrary(_T("e:\\PROJECT\\SolutionWare\\Projects\\2012.01.SmartDraw\\lib\\OpeningHoleDrawing_vc90_debug.dll"));
		if(hModule)
		{
			...
			if(NULL != pfAnnotate) pfAnnotate(
				_T("e:\\100S-S03.anno") , 
				_T("e:\\PROJECT\\SolutionWare\\Projects\\2012.01.SmartDraw\\SmartDraw_PDS\\Data\\bpa4 Project Opening\\Dra\\100S-S03.dra") , 
				_T("bpa4 Project Opening"),
				_T("e:\\PROJECT\\SolutionWare\\Projects\\2012.01.SmartDraw\\SmartDraw_PDS\\Data\\bpa4 Project Opening"));
