...
//  See http://www.codeproject.com/file/CFileFinderEx.asp
//////////////////////////////////////////////////////////////////////
//
...
public:
	...
	string	GetPath(BOOL bAppendArgs = FALSE, BOOL bOriginal = FALSE);
	string	GetShortPath();
	string	GetLongPath();
	...
	string	GetArgument(int nIndex = -1, BOOL bGetFlag = FALSE);
...
private:
	...
	public:
		...
		void SetFlag(string sFlagValue)
		{
			sFlag = sFlagValue;
	...
	typedef vector<CArgument, CArgument&> ATArguments;
