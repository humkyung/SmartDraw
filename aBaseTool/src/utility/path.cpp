...
//DEL BOOL CPath::GetFileTime(CTime &time, DWORD dwType)
//DEL {
//DEL 	BOOL bResult;
//DEL 	FILETIME *pTime = NULL;
//DEL 
//DEL 	bResult = FillFileInfoStruct();
//DEL 	switch (dwType)
//DEL 	{
//DEL 	case FILE_CREATION:	pTime = &_fis.ftCreationTime;	break;
//DEL 	case FILE_WRITE:	pTime = &_fis.ftLastWriteTime;	break;
//DEL 	case FILE_ACCESS:	
//DEL 	default:			pTime = &_fis.ftLastAccessTime;	break;
//DEL 	}
//DEL 
//DEL 	if (pTime != NULL) time = CTime(*pTime);
//DEL 	return bResult;
//DEL }
